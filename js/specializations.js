...
img3.onclick = function () {
  modal.style.display = "block";
  modalImg.src =
    "../img/Specializations/2) Cloud Development Specializations.jpg";
  captionText.innerHTML = this.alt;
};
...
img5.onclick = function () {
  modal.style.display = "block";
  modalImg.src =
    "../img/Specializations/4) AI (ML&DL) and Data Science Specializations.jpg";
  captionText.innerHTML = this.alt;
};
...
img6.onclick = function () {
  modal.style.display = "block";
  modalImg.src =
    "../img/Specializations/5) Web Development Specializations.jpg";
  captionText.innerHTML = this.alt;
};
